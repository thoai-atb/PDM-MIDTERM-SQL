...
ADD CONSTRAINT FK_Department_HeadInstructor FOREIGN KEY (head_instructor) REFERENCES Person.Instructor(instructor_id) ON UPDATE CASCADE ON DELETE SET NULL;
...
ADD CONSTRAINT FK_Course_Department FOREIGN KEY (department_id) REFERENCES College.Department(department_id) ON DELETE CASCADE,
	CONSTRAINT FK_Course_Instructor FOREIGN KEY (instructor_id) REFERENCES Person.Instructor(instructor_id) ON UPDATE CASCADE ON DELETE SET NULL;
	
ALTER TABLE Enroll.Enrolled
ADD CONSTRAINT FK_Enrolled_Student FOREIGN KEY (student_id) REFERENCES Person.Student(student_id) ON UPDATE CASCADE ON DELETE CASCADE,
